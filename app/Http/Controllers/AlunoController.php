...
class AlunoController extends Controller
{
    ...
    public function __construct(Aluno $aluno, Documento $documento, Color $color, Country $country)
    {
    ...
    public function create()
    {
        ...
        $title = "Area de Cadastro";
        return view('alunos.create', compact('colors', 'title','countries'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('alunos.edit', compact('aluno', 'documentos', 'colors', 'title','countries'));
    }
