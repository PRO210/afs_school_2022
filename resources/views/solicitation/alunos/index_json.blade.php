          ...
          <div class="container-fluid">
            ...
            <fieldset class="col-sm-12 col-md-12 px-6">
              ...
              <div class="row pt-2">
                ...
                <div class="col-sm-9">
                  <input type="text" placeholder="DIGITE O NOME DO RESPONSÁVEL" class="form-control" id="RESPONSAVEL_DECLARACAO"
                    name="RESPONSAVEL_DECLARACAO" value="" onkeyup="maiuscula(this)">
                </div>
              </div>
            </fieldset>
            <fieldset class="col-sm-12 col-md-12 px-6 ">
            ...
            <fieldset class="col-sm-12 col-md-12 px-6">
              ...
              <div class="row pt-2">
                ...
                <div class="col-sm-9">
                  <input type="text" placeholder="DIGITE O NOME DO RESPONSÁVEL" class="form-control" id="RESPONSAVEL_TRANSFERENCIA"
                    name="RESPONSAVEL_TRANSFERENCIA" onkeyup="maiuscula(this)">
                </div>
              </div>
            </fieldset>
            <fieldset class="col-sm-12 col-md-12 px-6 ">
            ...
            <fieldset class="col-sm-12 col-md-12 px-6 ">
              {{-- <legend>Status da Transferência</legend> --}}
              <div class="row pt-2">
                <label for="" class="col-sm-3 col-form-label">Registrado:</label>
                <div class="col-sm-4">
            ...
            <div class="container mt-3">
              <div class="row">
                <div class="col">
                  <button type="submit" name="botao" value="update" class="btn btn-outline-success btn-block" onclick="return confirmar()">Salvar as
                    Alterações
                  </button>
                </div>
                <div class="col">
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        for (var i in $txt) {
          ...
          $('#REGISTRADO :selected').text($txt[i]["REGISTRADO"]);
