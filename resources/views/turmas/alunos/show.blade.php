...
@section('content')
  ...
  <form action="{{ route('turmas.aluno.attach', $aluno->uuid) }}" method="POST" class="form">
    ...
    <h5 style="margin: 12px">Aluno(a): {{ $aluno->NOME }}</h5>
              ...
              <label for="" class="col-sm-2 control-label">Status:</label>
                      ...
                      <select name="classification_id[]" id="" class=" form-control">
                        ...
                        @if ($turma->pivot->classification_id == '3')
                          ...
                          @foreach ($classifications as $classificacao)
                        ...
                        @else
                          ...
                          @foreach ($classifications as $classification)
                            ...
                            @else
                              ...
                              @if ($classification->id == '1' || $classification->id == '2' || $classification->id == '5')
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="DECLARACAO_RESPONSAVEL[]" value="{{ $turma->pivot->DECLARACAO_RESPONSAVEL }}" class=" form-control"
                        placeholder="">
                    </div>
                  </div>
                  <br>
                  ...
                  <div class="row">
                    <label for="" class="col-sm-2 control-label">Responsável:</label>
                    <div class="col-sm-10">
                      <input type="text" name="TRANSFERENCIA_RESPONSAVEL[]" value="{{ $turma->pivot->TRANSFERENCIA_RESPONSAVEL }}"
            ...
            <fieldset class="col-sm-12 col-md-12 px-6">
              ...
              <div id="{{ $key }}{{ $turma_02->id }}" style="display: none;">
                  ...
                  <div class="col-sm-4">
                    <select name="classification_id_02[]" id="" class=" form-control">
                      @foreach ($classifications as $classificacao)
                        ...
                        @if ($classificacao->id == '1' || $classificacao->id == '2')
                ...
                <div class="row">
                  <label for="" class="col-sm-2 control-label">Responsável:</label>
                  <div class="col-sm-10">
                    <input type="text" name="DECLARACAO_RESPONSAVEL_02[]" value="{{ $turma_02->DECLARACAO_RESPONSAVEL }}" class=" form-control"
                      placeholder="">
                  </div>
                </div>
                <br>
                ...
                <div class="row">
                  <label for="" class="col-sm-2 control-label">Responsável:</label>
                  <div class="col-sm-10">
                    <input type="text" name="TRANSFERENCIA_RESPONSAVEL_02[]" value="{{ $turma_02->TRANSFERENCIA_RESPONSAVEL }}"
                      class=" form-control" placeholder="">
                  </div>
                </div>
            </fieldset>
